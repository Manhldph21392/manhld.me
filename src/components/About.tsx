...
const informations: info[] = [
  ...
  {
    title: "Email",
    content: "manhld21082003@gmail.com",
  },
  {
    title: "Địa chỉ",
  ...
  {
    title: "Website",
    content: "https://manhluu.vercel.app",
  },
  {
    title: "Nghề nghiệp",
              ...
              <div className="p-7 md:py-10 flex flex-col md:flex-row items-center justify-between gap-6 bg-white dark:bg-dark-200">
                ...
                <div className="flex-1 ">
                  <div className="pb-4 border-b border-gray-500">
                    ...
                    <p>
                      Hiện tại, mình đang là sinh viên kì 5 tại trường FPT
                    ...
                    <p className="pt-2">
                      ...
                      là trở thành một lập trình viên Frontend.Và gần đây mình bắt đầu tìm hiểu sang Backend
                    </p>
                  </div>
