...
const Home: NextPage = ({
  ...
  return (
    <>
      <Head>
        <title>ManhLuu</title>
        <meta property="og:title" content="ManhLuu" key="title" />
        <meta property="og:url" content="https://manhluu.vercel.app/" />
        <meta property="og:type" content="website" />
        <meta
          name="description"
          content="Front-end developer, Web developer."
        />
        <meta property="og:image" content="/ld-remove.png" />
        <link rel="icon" href="/icon_fake.png" />
        <link rel="apple-touch-icon" href="/icon_fake.png" />
      </Head>
